...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  List<String> get _candidateBaseUrls => [
    ...?(_cachedBaseUrl == null ? null : [_cachedBaseUrl!]),
    ApiConfig.baseUrl,
    'http://10.0.2.2:8000',
    'http://127.0.0.1:8000',
    'http://localhost:8000',
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                        colors: [Color(0xFFA55233), Color(0xFF7D3920)],
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: const Color(0xFFA55233).withValues(alpha: 0.25),
                          blurRadius: 16,
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Manage bookings, pets, payouts & services',
                                style: GoogleFonts.plusJakartaSans(
                                  fontSize: 11.5,
                        ...
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            foregroundColor: const Color(0xFFA55233),
                            elevation: 0,
